...
CREATE TABLE empleado (
    nDIEmp TEXT PRIMARY KEY,
    nomEmp TEXT NOT NULL,
    sexEmp TEXT CHECK(sexEmp IN ('M', 'F')) NOT NULL,
    fecNac DATE NOT NULL,
    fecIncorporacion DATE NOT NULL,
    salEmp NUMERIC NOT NULL,
    comisionE NUMERIC NOT NULL DEFAULT 0.0,
    cargoE TEXT NOT NULL,
    jefeID TEXT,
    codDepto TEXT NOT NULL,
...
SELECT '3. Obtener los datos de los empleados cuyo cargo sea ''Secretaria'' o ''Secretario''.' as ejercicio;
-- Ver: https://sqlite.org/quirks.html#double_quoted_string_literals_are_accepted
...
SELECT '12. Obtener el documento, nombre, salario, comisión y el salario total de empleados cuya comisión sea superior a 10.000 €, ordenado por documento.' as ejercicio;
...
-- Ver: https://stackoverflow.com/a/3335202/32697703
-- En sqlite no se pueden crear procedures (procedimientos almacenados)
SELECT 'En sqlite no se pueden crear procedures (procedimientos almacenados).' as resultado;


SELECT '20. Crear un trigger que, cada vez que se inserte un nuevo empleado registre automáticamente en un log.' as ejercicio;
...
DELETE FROM empleado WHERE nDIEmp = '33303001L';
...
-- Limpiamos la vista y el trigger dejando sólo el modelo original
DELETE FROM empleado WHERE nDIEmp = '33303001L';
DROP TABLE IF EXISTS log_transacciones;
