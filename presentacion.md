...
h1 { font-size: 28px !important; margin-top: 20px; color: #00509e; }
h2 { font-size: 22px !important; border-bottom: 1px solid #ccc; padding-bottom: 5px; }
h3 { font-size: 18px !important; }

.farmia-logo { height: 100px; }
...
.toc { font-size: 18px; }
.toc a { color: #222; }
.toc li { margin: 20px 0; }
.toc ul:first-child { margin-top: 100px;  }
.toc ul { list-style-type: none; padding-left: 15px; }

/* Referencias */
.references p { font-size: 12px; margin-bottom: 4px; }
.references a { color: -webkit-link; }
</style>
